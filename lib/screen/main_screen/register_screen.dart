...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void uploadStorage(int num) async{
    ...
    final store = storage.ref().child("photos").child("${auth.currentUser!.email}${password}$num");
    ...
    await db.collection("products").doc("${auth.currentUser!.email}${password}").update(map);
  ...
  void registerPressed() async{
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Checking registration information. Please wait a moment.")));
    if(key.currentState!.validate()){
      if(sort!=null && photoLength!=0){
        if(checkChat ==true || checkMessage==true || checkCall==true){
         ...
         if(avoidData.docs.length>1){
           ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("This product has already been registered.")));
           return;
         }

          key.currentState!.save();
          HashMap<String,dynamic> response = await Navigator.of(context).push(MaterialPageRoute(builder: (context) => BuyScreen(price:price!)));
         ...
         await db.collection("products").doc("${auth.currentUser!.email}$password").set(map);
         for(int i=0; i <photoLength; i++){
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please enter your content.")));
        }
      }else{
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please enter your content.")));
      }
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder:
              OutlineInputBorder(borderSide: BorderSide(color: Colors.black,width:1.5),),
        ),
      ),
    );
  }
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(1),onSaved: (value){
                              sitename = value!;
                            })),
                            Checkbox(value: checkSitename, onChanged: (value) {
                              setState((){
                                checkSitename = value!;
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(2),onSaved: (value){
                              domainname = value!;
                            })),
                            Checkbox(value: checkDomainname, onChanged: (value) {
                              setState((){
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(3),onSaved: (value){
                              contentname = value!;
                            })),
                          ],
                        ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(4),onSaved: (value){
                              price = value!;
                            })),
                            Image.asset(
                            ...
                            Checkbox(value: checkPrice, onChanged: (value) {
                              setState((){
                                checkPrice = value!;
                              });
                            },activeColor: MAIN_COLOR),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                                child: Row(
                              children: [
                                Checkbox(value: checkApp, onChanged: (value) {
                                  setState((){
                                    checkApp = value!;
                                    if(checkApp==true){
                                ...
                                Checkbox(value: checkWebsite, onChanged: (value) {
                                  setState((){
                                    checkWebsite = value!;
                                ...
                                Checkbox(value: checkYoutube, onChanged: (value) {
                                  setState((){
                                    checkYoutube = value!;
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          customTextfeild(key:ValueKey(5),detail: "detail",onSaved: (value){
                            detail = value!;
                          }),
                        ],
                      ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(6),onSaved: (value){
                              member = value!;
                            })),
                            Padding(
                            ...
                            Checkbox(value: checkMember, onChanged: (value) {
                              setState((){
                                checkMember = value!;
                              });
                            },activeColor: MAIN_COLOR),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(7),onSaved: (value){
                              year = value!;
                            })),
                            Padding(
                              padding: EdgeInsets.only(left: 5),
                            ...
                            Checkbox(value: checkYear, onChanged: (value) {
                              setState((){
                                checkYear = value!;
                              });
                            },activeColor: MAIN_COLOR),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(8),onSaved: (value){
                              netprofit = value!;
                            })),
                            Padding(
                              padding: EdgeInsets.only(left: 5),
                            ...
                            Checkbox(value: checkNetprofit, onChanged: (value) {
                              setState((){
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(9),onSaved: (value){
                              day = value!;
                            })),
                            Padding(
                              padding: EdgeInsets.only(left: 5),
                            ...
                            Checkbox(value: checkDay, onChanged: (value) {
                              setState((){
                                checkDay = value!;
                              });
                            },activeColor: MAIN_COLOR),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(10),onSaved: (value){
                              managemonth = value!;
                            })),
                            Padding(
                              padding: EdgeInsets.only(left: 5),
                            ...
                            Checkbox(value: checkManagemonth, onChanged: (value) {
                              setState((){
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(11),onSaved: (value){
                              enrollname = value!;
                            })),
                          ],
                        ),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(12),onSaved: (value){
                              enrollphone = value!;
                            })),
                            Checkbox(value: checkPhone, onChanged: (value) {
                              setState((){
                                checkPhone = value!;
                              });
                            },activeColor: MAIN_COLOR),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: customTextfeild(key:ValueKey(13),onSaved: (value){
                              enrollmail = value!;
                            })),
                          ],
                        ),
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                Checkbox(value: checkCall, onChanged: (value) {
                                  setState((){
                                    checkCall = value!;
                                  });
                                },activeColor: MAIN_COLOR),
                                ...
                                Checkbox(value: checkMessage, onChanged: (value) {
                                  setState((){
                                    checkMessage = value!;
                                  });
                                },activeColor: MAIN_COLOR),
                                ...
                                Checkbox(value: checkChat, onChanged: (value) {
                                  setState((){
                                    checkChat = value!;
                                  });
                                },activeColor: MAIN_COLOR),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("(koreans only) 계좌이체를 할 경우, 입금자명과 등록자명이 같아야 합니다."),
                          SizedBox(
                            height: 10,
                          ),
                          SizedBox(
